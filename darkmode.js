// Create a bookmark with name DARK and content:
javascript:(function(){ 
  function invert(o,t) {
    var r=o.split("("),n=r[1].split(")")[0].split(",");
    return n.forEach(function(o,r){ 
      r<3 && (n[r]="color" == t&& 255-parseInt(o) < 50?120:255-parseInt(o))}),
      n=n.join(","),
      r[0]+"("+n+")"
  }
  document.querySelectorAll("*:not([invTouch])")
    .forEach(function(o){ 
...
// Create a bookmark with name DARKO and content:
javascript: (function () {   
  if (document.children[0].style['filter']) {     
    document.children[0].style['filter'] = ''   } else {     
