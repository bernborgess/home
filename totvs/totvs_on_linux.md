...
# Created symlink /etc/systemd/system/multi-user.target.wants/totvsappserver.service -> /usr/lib/systemd/system/totvsappserver.service
systemctl start totvsappserver.service
systemctl status totvsappserver.service
# Active: active (running)
```
